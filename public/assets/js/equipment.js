...
function filterSystemUnits() {
    ...
    fetch('../ajax/manage_systemunit.php?action=list&search=' + encodeURIComponent(search))
        ...
        .catch(function(error) { Alerts.error('Error loading system units: ' + error); });
}
...
function editSystemUnit(id) {
    fetch('../ajax/manage_systemunit.php?action=get&systemunit_id=' + id)
        ...
        .catch(function(error) { Alerts.error('Error loading system unit: ' + error); });
}
...
function saveSystemUnit() {
    ...
    fetch('../ajax/manage_systemunit.php', { method: 'POST', body: formData })
        ...
        .catch(function(error) { Alerts.error('Error saving system unit: ' + error); });
}

function deleteSystemUnit(id) {
    Alerts.confirmDelete('this system unit', function() {
        var formData = new FormData();
        ...
        fetch('../ajax/manage_systemunit.php', { method: 'POST', body: formData })
            .then(function(response) { return response.json(); })
            .then(function(data) {
                if (data.success) { Alerts.success(data.message); reloadEquipmentPage(); }
                else { Alerts.error(data.message); }
            })
            .catch(function(error) { Alerts.error('Error deleting system unit: ' + error); });
    });
}
...
function filterMonitors() {
    ...
    fetch('../ajax/manage_monitor.php?action=list&search=' + encodeURIComponent(search))
        ...
        .catch(function(error) { Alerts.error('Error loading monitors: ' + error); });
}
...
function editMonitor(id) {
    fetch('../ajax/manage_monitor.php?action=get&monitor_id=' + id)
        ...
        .catch(function(error) { Alerts.error('Error loading monitor: ' + error); });
}
...
function saveMonitor() {
    ...
    fetch('../ajax/manage_monitor.php', { method: 'POST', body: formData })
        ...
        .catch(function(error) { Alerts.error('Error saving monitor: ' + error); });
}

function deleteMonitor(id) {
    Alerts.confirmDelete('this monitor', function() {
        var formData = new FormData();
        formData.append('action', 'delete');
        ...
        fetch('../ajax/manage_monitor.php', { method: 'POST', body: formData })
            ...
            .catch(function(error) { Alerts.error('Error deleting monitor: ' + error); });
    });
}
...
function filterAllInOnes() {
    ...
    fetch('../ajax/manage_allinone.php?action=list&search=' + encodeURIComponent(search))
        ...
        .catch(function(error) { Alerts.error('Error loading all-in-ones: ' + error); });
}
...
function editAllInOne(id) {
    fetch('../ajax/manage_allinone.php?action=get&allinone_id=' + id)
        ...
        .catch(function(error) { Alerts.error('Error loading all-in-one: ' + error); });
}
...
function saveAllInOne() {
    ...
    fetch('../ajax/manage_allinone.php', { method: 'POST', body: formData })
        ...
        .catch(function(error) { Alerts.error('Error saving all-in-one: ' + error); });
}

function deleteAllInOne(id) {
    Alerts.confirmDelete('this all-in-one PC', function() {
        var formData = new FormData();
        formData.append('action', 'delete');
        ...
        fetch('../ajax/manage_allinone.php', { method: 'POST', body: formData })
            ...
            .catch(function(error) { Alerts.error('Error deleting all-in-one: ' + error); });
    });
}
...
function editPrinter(id) {
    fetch('../ajax/manage_printer.php?action=get&printer_id=' + id)
        ...
        .catch(function(error) { Alerts.error('Error loading printer: ' + error); });
}
...
function savePrinter() {
    ...
    for (var i = 0; i < requiredIds.length; i++) {
        if (!document.getElementById(requiredIds[i]).value.trim()) {
            Alerts.warning('Please fill in all required fields marked with *');
            return;
        }
    }
    ...
    fetch('../ajax/manage_printer.php', { method: 'POST', body: formData })
        ...
        .catch(function(error) { Alerts.error('Error saving printer: ' + error); });
}
...
function deletePrinter(id) {
    Alerts.confirmDelete('this printer', function() {
        ...
        fetch('../ajax/manage_printer.php', { method: 'POST', body: formData })
            ...
            .catch(function(error) { Alerts.error('Error deleting printer: ' + error); });
    });
}
...
function editOtherEquipment(id) {
    fetch('../ajax/manage_otherequipment.php?action=get&id=' + id)
        ...
        .catch(function(error) { Alerts.error('Error loading equipment details: ' + error); });
}

function saveOtherEquipment() {
    var typeInput = document.getElementById('otherType');
    if (!typeInput || !typeInput.value.trim()) {
        Alerts.warning('Please enter equipment type');
        return;
    }
    ...
    fetch('../ajax/manage_otherequipment.php', { method: 'POST', body: formData })
        ...
        .catch(function(error) { console.error(error); Alerts.error('System Error: ' + error); });
}

function deleteOtherEquipment(id) {
    Alerts.confirmDelete('this equipment', function() {
        var formData = new FormData();
        formData.append('action', 'delete');
