            ...
            <tbody id="printerTableBody">
                ...
                <?php else: ?>
                    ...
                    <tr data-printer-id="<?php echo $p['printerId']; ?>"
                        ...
                        <td>
                            <span class="serial-number"><?php echo htmlspecialchars($p['printerSerial'] ?? 'N/A'); ?></span>
                        </td>
                        <td>
                        ...
                        <td>
                            <span class="year-acquired"><?php echo htmlspecialchars($p['yearAcquired'] ?? 'N/A'); ?></span>
                        </td>
                        <td>
                            <?php if ($p['employeeName']): ?>
                                <div class="assigned-employee">
                                    <i class="fas fa-user"></i>
                                    <?php echo htmlspecialchars($p['employeeName']); ?>
                                </div>
                        ...
                        <td>
                            <div class="action-buttons">
                                <button class="btn-action btn-edit" title="Edit" onclick="editPrinter(<?php echo $p['printerId']; ?>)">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button class="btn-action btn-delete" title="Delete" onclick="deletePrinter(<?php echo $p['printerId']; ?>)">
                    ...
                    <div class="form-section">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="printerSerial" required placeholder="Enter serial number">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <small class="form-text text-muted">
                                    <i class="fas fa-info-circle"></i>
                                    If assigned, status automatically becomes "Working"
                                </small>
                            </div>
                        </div>
                    </div>
