 ...
 * Manages non-standard computer equipment (Projectors, Switches, etc.)
 */
...
// Fetch Locations for Modal Dropdown
...
// Fetch Employees for Modal Dropdown
...
<div class="page-header">
    <h2>
        ...
        Other ICT Equipment Management
    </h2>
...
<div class="stats-grid">
    ...
    <div class="stat-card">
        ...
        <div class="stat-value"><?php echo $maintenanceCount; ?></div>
    </div>
</div>
        ...
        <table id="otherTable">
            ...
            <tbody id="otherTableBody">
                ...
                <?php else: ?>
                    ...
                    <?php 
                        // Determine display status and CSS class
                    ...
                    <tr data-equipment-id="<?php echo $o['otherEquipmentId']; ?>"
                        ...
                        <td>
                            <span class="serial-number"><?php echo htmlspecialchars($o['serialNumber']); ?></span>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <?php if($o['details']): ?>
                                <div class="equipment-details">
                                    <?php echo htmlspecialchars(substr($o['details'], 0, 50)) . (strlen($o['details']) > 50 ? '...' : ''); ?>
                                </div>
                            <?php endif; ?>
                        </td>
                        <td>
                        ...
                        <td>
                            <?php if ($o['employeeName']): ?>
                                <div class="assigned-employee">
                                    ...
                                    <?php echo htmlspecialchars($o['employeeName']); ?>
                                </div>
                            <?php else: ?>
                        ...
                        <td>
                            <span class="year-acquired"><?php echo htmlspecialchars($o['yearAcquired']); ?></span>
                        </td>
                        <td>
                            <div class="action-buttons">
                                <button class="btn-action btn-view" title="View Details" onclick="viewOtherEquipment(<?php echo $o['otherEquipmentId']; ?>)">
                                    <i class="fas fa-eye"></i>
                                </button>
                                <button class="btn-action btn-edit" title="Edit" onclick="editOtherEquipment(<?php echo $o['otherEquipmentId']; ?>)">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button class="btn-action btn-delete" title="Delete" onclick="deleteOtherEquipment(<?php echo $o['otherEquipmentId']; ?>)">
...
<script>
    // Pass PHP equipment data as JSON
