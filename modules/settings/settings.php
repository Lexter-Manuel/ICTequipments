...
// ── Auto-seed defaults if the table was truncated / is empty ──
$rowCount = (int) $db->query("SELECT COUNT(*) FROM system_settings")->fetchColumn();
if ($rowCount === 0) {
    $seeds = [
        // Organization
    ...
    $ins = $db->prepare("INSERT IGNORE INTO system_settings (setting_key, setting_value, setting_group, label, description) VALUES (?,?,?,?,?)");
