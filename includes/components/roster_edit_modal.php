...
<div class="modal fade" id="edit_cropModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="crop-container" style="width: 100%; max-height: 500px; display: flex; justify-content: center; background: #000; overflow: hidden;">
                    <img id="edit_imageToCrop" src="" alt="Image to crop" style="max-width: 100%; max-height: 500px;">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
